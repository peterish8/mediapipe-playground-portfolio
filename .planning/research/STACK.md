...
**Domain:** Client-side, zero-server, multi-page WASM/WebGPU creative-AI showcase site (MediaPipe Playground)
**Researched:** 2026-07-27
**Confidence:** HIGH (core Vite/MediaPipe config verified against Google's own current official samples repo, live npm registry, and GitHub issue threads; MEDIUM on newer/fast-moving pieces like Tailwind v4 and Vite 8; LOW flagged explicitly where noted)
...
```bash
# Core
npm install @mediapipe/tasks-vision @mediapipe/tasks-genai tone
...
npm install -D eslint eslint-plugin-html prettier
```
...
**If you deploy to Netlify, Vercel, or Cloudflare Pages:**
...
**If any single demo page needs a PostCSS plugin beyond Tailwind (e.g. `postcss-nesting` for a hand-rolled CSS module):**
...
---
*Stack research for: client-side, zero-server, multi-page WASM/WebGPU creative-AI showcase site (MediaPipe Playground)*
*Researched: 2026-07-27*
